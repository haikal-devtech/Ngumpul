...
const securityHeaders = [
  ...
  // realtime websocket, DiceBear/Unsplash images, and Vercel Speed Insights.
  {
    ...
    value: [
      "default-src 'self'",
      // Scripts: self + next.js inline scripts + Vercel Speed Insights
      ...
      // Images: self + Unsplash + DiceBear + Google + Supabase storage
      "img-src 'self' data: blob: https://images.unsplash.com https://api.dicebear.com https://lh3.googleusercontent.com https://*.supabase.co",
      // XHR / fetch: self + Google APIs + Supabase
      "connect-src 'self' https://maps.googleapis.com https://*.supabase.co wss://*.supabase.co https://va.vercel-scripts.com",
